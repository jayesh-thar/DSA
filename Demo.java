...
*/
        ...
        // +ve/-ve
        int xy = -50;
        if(xy<0) System.out.println(xy + " is -ve");
        else System.out.println(xy + " is +ve");
        ...
        double val = 10.00001;
        int valInt = (int)val;
        if((val-valInt) > 0) System.out.println("not integer...");
        else System.out.println("integer...");


        // 4-digit?
        int isFour = 5585;
        if(isFour>999 && isFour<10000) System.out.println("4 Digit...");
        ...
        //(values%2==0) ? sout("even") : sout("odd"); ===> not work in JAVA, work in c and js
        int values = 15;
